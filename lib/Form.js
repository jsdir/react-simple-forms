...
var Form = React.createClass({
  ...
  registerField: function(element, fieldName) {
    this._formFieldElements[fieldName] = element;
    var initialFieldState = {
      value: this.props.defaultValue[fieldName] || null,
      error: null,
      state: 'loading', // TODO: initially validate,
      isPristine: true,
  ...
  changeFieldValue: function(fieldName, value, validators) {
    var self = this;
  ...
  submit: function() {
    ...
    this._updateFormState({submitting: true, submitError: null});
